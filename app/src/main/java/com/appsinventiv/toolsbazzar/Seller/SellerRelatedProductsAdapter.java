...
public class SellerRelatedProductsAdapter extends RecyclerView.Adapter<SellerRelatedProductsAdapter.Viewholder> {
    Context context;
    ArrayList<Product> productList;
    private ArrayList<Product> arrayList = new ArrayList<>();


    public SellerRelatedProductsAdapter(Context context,
                                        ArrayList<Product> productList
    ) {
    ...
    @NonNull
    @Override
    public SellerRelatedProductsAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.seller_related_product_item_layout, parent, false);
        SellerRelatedProductsAdapter.Viewholder viewHolder = new SellerRelatedProductsAdapter.Viewholder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final SellerRelatedProductsAdapter.Viewholder holder, final int position) {
...
//        }
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        TextView title, subtitle, price, oldPrice;
