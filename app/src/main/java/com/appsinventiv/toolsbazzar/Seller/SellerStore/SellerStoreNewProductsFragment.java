...
public class SellerStoreNewProductsFragment extends Fragment {
    ...
    public SellerStoreNewProductsFragment() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public SellerStoreNewProductsFragment(String text, String sellerId) {
        this.text = text;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_new_seller_store
                , container, false);
