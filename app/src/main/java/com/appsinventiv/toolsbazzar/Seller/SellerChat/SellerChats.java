...
import com.appsinventiv.toolsbazzar.Seller.Sales.SalesFragmentAdapter;
...
public class SellerChats extends AppCompatActivity implements NotificationObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_chats);
        this.setTitle("My Chats");
        ...
        soundId = sp.load(SellerChats.this, R.raw.tick_sound, 1);
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        if (chatModel != null) {
                            if (!chatModel.getUsername().equals(SharedPrefs.getUsername())) {
                                mDatabase.child("Chats/SellerChats").child(SharedPrefs.getUsername()).child(chatModel.getId()).child("status").setValue("read");
                            }
                        }
                    }
    ...
    public void onSuccess(String chatId) {
        mDatabase.child("Chats/SellerChats").child(SharedPrefs.getUsername()).child(chatId).child("status").setValue("delivered");
    }
