        ...
        adapter = new WishListAdapter(Whishlist.this, productArrayList, userCartProductList, userWishList, new AddToCartInterface() {
            ...
            public void addedToCart(final Product product, final int quantity, int position) {
                ...
                if (product.getAttributesWithPics() != null) {
                    ShowBottomDialog.showSizeAndColorDialogNew(Whishlist.this, product, quantity, mDatabase, new ShowBottomDialog.AttributesListener() {
                    ...
                    if (product.getSizeList() != null && product.getColorList() != null) {
                        ShowBottomDialog.showSizeAndColorDialog(Whishlist.this, product, quantity, mDatabase, new ShowBottomDialog.AttributesListener() {
                        ...
                        ShowBottomDialog.showSizeBottomDialog(Whishlist.this, product, quantity, mDatabase, new ShowBottomDialog.AttributesListener() {
                        ...
                        ShowBottomDialog.showColorBottomDialog(Whishlist.this, product, quantity, mDatabase, new ShowBottomDialog.AttributesListener() {
