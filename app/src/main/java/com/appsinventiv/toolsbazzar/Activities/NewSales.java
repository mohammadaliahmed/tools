        ...
        adapter = new SearchProductsAdapter(NewSales.this, productArrayList, userCartProductList, userWishList, new AddToCartInterface() {
            ...
            public void addedToCart(final Product product, final int quantity, int position) {
                ...
                if (product.getAttributesWithPics() != null) {
                    ShowBottomDialog.showSizeAndColorDialogNew(NewSales.this, product, quantity, mDatabase, new ShowBottomDialog.AttributesListener() {
                    ...
                    if (product.getSizeList() != null && product.getColorList() != null) {
                        ShowBottomDialog.showSizeAndColorDialog(NewSales.this, product, quantity, mDatabase, new ShowBottomDialog.AttributesListener() {
                        ...
                        ShowBottomDialog.showSizeBottomDialog(NewSales.this, product, quantity, mDatabase, new ShowBottomDialog.AttributesListener() {
                        ...
                        ShowBottomDialog.showColorBottomDialog(NewSales.this, product, quantity, mDatabase, new ShowBottomDialog.AttributesListener() {
